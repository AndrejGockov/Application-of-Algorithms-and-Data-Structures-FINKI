...
//      Од дадената листа потребно е да се најде последниот јазел којшто содржи String со должина L и да се премести на почеток на листата.
//
...
public class Main {
    public static void main(String[] args) {
        ...
        while(node != null){
            if(node.element.length() == wantedLength)
        ...
        newList.insertFirst(firstElement);

        while(node != null){
            if(node.element != firstElement)
