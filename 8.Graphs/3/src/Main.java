...
//        Излез:
//        2
//        (Објаснување: Ако падне рутерот 1 ќе се појават две групи: 0 и 2,3,4)
//
//        /
//
...
//        Output:
//        2
//        (Explanation: If router 1 fails, the network will split into two groups: 0 and 2,3,4.)
...
public class Main {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < connections; i++){
            routers.addEdge(input.nextInt(), input.nextInt());
        }

        int failedRouter = input.nextInt();
        routers.removeVertex(failedRouter);

        System.out.println(routers.countRouter());
    }
}