...
//
//        Излез:
//        450 (Објаснување: ќе се воспостават врските London-Brussels, Brussels-Amsterdam и Brussels-Paris)
//
//        /
//
//        A company wants to establish a communication network between its offices in different cities. They have a list of potential connections between cities, along with their costs. The company wants to minimize the total cost of connecting all cities. Determine the minimum cost to connect all cities.
//
//        Input: The first line contains the number of cities N. The next N lines contain the names of the cities. The next line contains the number of possible connections M, followed by M lines that contain the two cities connected by each connection and the cost of establishing that connection.
//
...
public class One {
    public static void main(String[] args) {
        ...
        AdjacencyMatrixGraph<String> cityNetwork = new AdjacencyMatrixGraph<>(N);
        ...
        for (int i = 0; i < M; i++) {
            ...
            cityNetwork.addEdge(mapping.get(city1), mapping.get(city2), cost);
        }
